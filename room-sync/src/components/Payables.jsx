  ...
  useEffect(() => {
    ...
    const fetchBills = async () => {
      try {
        ...
        // Create a query to fetch documents where the 'month' field matches the selected month
        const q = query(payablesRef, where("month", "==", month));
        ...
        if (!querySnapshot.empty) {
          ...
          querySnapshot.forEach((doc) => {
            // Add each document's data to the billsData array
            billsData.push(...doc.data().bills); // Assuming 'bills' is an array in the document
          });
          setBills(billsData);
          console.log("Fetched payables:", billsData);
        } else {
          console.log("No matching documents!");
          setBills([]); // Clear bills if no documents are found
        }
      } catch (error) {
