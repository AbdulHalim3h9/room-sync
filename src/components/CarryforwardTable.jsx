...
const CarryforwardTable = ({
  ...
  return (
    <div className="w-full">
      {/* Rotatable container for smaller screens */}
      <div className="relative w-full">
        <div className="absolute -top-4 left-1/2 -translate-x-1/2 text-sm text-gray-500 sm:hidden">
          Rotate device to landscape for better view
        </div>
        <div className="w-full sm:w-auto sm:min-w-[600px] transform sm:transform-none sm:rotate-0 rotate-90 origin-top-left -mt-6 sm:-mt-0">
          <div className="w-full sm:w-auto sm:min-w-[600px] transform sm:transform-none sm:rotate-0 rotate-90 origin-top-left">
