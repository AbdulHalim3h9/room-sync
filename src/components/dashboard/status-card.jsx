    ...
    <div className="w-full">
      ...
      <div className="flex justify-between items-center mb-3">
        <div className="flex items-center gap-1.5">
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-3 py-1.5 rounded-full shadow-md flex items-center">
        ...
        <span className={`text-xs ${dueMembers.length > 0 ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'} px-2 py-1 rounded-full font-medium`}>
          {mealRate === "N/A" ? "Rate: N/A" : `Rate: ${mealRate} tk`}
        </span>
      </div>
